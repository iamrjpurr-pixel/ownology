...
- [ ] **Ghost Questions seed (~200 LLM-generated)** linked by `wbs_code` × `wine_type` × `stage`. Surface 1 per Cellar Brief card to deepen educational context AND lay the foundation for `/q/<slug>` SEO pages.
