...
export const FLASHCARDS: Flashcard[] = [
  ...
  },
  {
    ...
    plain: "Drop some grapes on the ground to make the remaining ones more concentrated. Sounds wasteful — it's actually how premium wines are made. Done at bud-break (shoot thin) or véraison (cluster thin).",
