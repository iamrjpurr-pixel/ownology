...
type Tab = "voice" | "camera" | "paste" | "csv";
...
export default function Import() {
  ...
  const [importSource, setImportSource] = useState<"paste" | "csv" | "image" | "voice">("image");
  const [saving, setSaving] = useState(false);
  const [saved, setSaved] = useState(false);
  const bulkSave = trpc.vintageLog.bulkSave.useMutation();

  const handleEntries = useCallback(
    (newEntries: ParsedEntry[], source: "paste" | "csv" | "image" | "voice") => {
