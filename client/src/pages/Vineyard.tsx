...
function BlockCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 p-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span style={{ fontFamily: "'Fraunces', serif", fontWeight: 600, color: "oklch(0.92 0.015 75)", fontSize: "0.95rem" }}>
              {block.blockName}
            </span>
            <span
              className="px-2 py-0.5 rounded text-xs"
              style={{ background: "oklch(0.72 0.12 75 / 15%)", color: "oklch(0.72 0.12 75)", fontFamily: "'Lato', sans-serif" }}
            >
              {block.variety}
            </span>
          </div>
          <div className="flex items-center gap-3 mt-0.5" style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.75rem", color: "oklch(0.55 0.012 75)" }}>
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            style={{ color: "oklch(0.72 0.12 75)", fontSize: "0.75rem", height: "28px", padding: "0 8px" }}
          >
            <Plus size={12} className="mr-1" /> Log
          </Button>
          <button
            onClick={() => setExpanded((e) => !e)}
            style={{ color: "oklch(0.55 0.012 75)", background: "none", border: "none", cursor: "pointer", padding: "4px" }}
          >
      ...
      {expanded && (
        <div style={{ borderTop: "1px solid oklch(0.20 0.008 60)", padding: "12px 16px" }}>
          {block.notes && (
            ...
            <div className="flex flex-col gap-2">
              {blockObs.map((obs) => (
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.8rem", color: "oklch(0.80 0.015 75)", textTransform: "capitalize" }}>
                        {obs.observationType.replace(/_/g, " ")}
                      </span>
                      {obs.value !== null && (
                        <span style={{ fontFamily: "'Fira Code', monospace", fontSize: "0.75rem", color: "oklch(0.72 0.12 75)" }}>
                      ...
                      <span
                        ...
                        style={{ background: "oklch(0.20 0.010 60)", color: "oklch(0.55 0.012 75)" }}
                      >
                        {obs.vintageYear}
                      </span>
                    </div>
...
export default function Vineyard() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "oklch(0.11 0.008 60)", fontFamily: "'Lato', sans-serif" }}>
      {/* Header */}
      <div style={{ borderBottom: "1px solid oklch(0.18 0.008 60)", padding: "24px 0" }}>
        <div className="container">
          <div className="flex items-center justify-between">
            <div>
              <h1 style={{ fontFamily: "'Fraunces', serif", fontWeight: 700, fontSize: "1.8rem", color: "oklch(0.92 0.015 75)" }}>
                Vineyard
              </h1>
              <p style={{ color: "oklch(0.55 0.012 75)", fontSize: "0.85rem", marginTop: "4px" }}>
                Block register · Phenology · Observations
              </p>
            </div>
            <Button
              onClick={() => setShowAddBlock(true)}
              style={{ background: "oklch(0.72 0.12 75)", color: "oklch(0.11 0.008 60)", fontFamily: "'Lato', sans-serif", fontWeight: 600 }}
            >
          ...
          {(blocks as Block[]).length > 0 && (
            <div className="flex items-center gap-6 mt-4">
              {[
                ...
                <div key={stat.label}>
                  <div style={{ fontFamily: "'Fira Code', monospace", fontSize: "1.1rem", color: "oklch(0.72 0.12 75)", fontWeight: 600 }}>
                    {stat.value}
                  </div>
      ...
      <div className="container" style={{ paddingTop: "24px", paddingBottom: "48px" }}>
        {isLoading ? (
          ...
          <div style={{ textAlign: "center", padding: "64px 0" }}>
            ...
            <p style={{ color: "oklch(0.55 0.012 75)", fontSize: "1rem", marginBottom: "8px" }}>No vineyard blocks registered yet</p>
            <p style={{ color: "oklch(0.40 0.010 60)", fontSize: "0.85rem", marginBottom: "24px" }}>
      ...
      <Dialog open={showAddBlock} onOpenChange={setShowAddBlock}>
        <DialogContent style={{ background: "oklch(0.14 0.008 60)", border: "1px solid oklch(0.22 0.010 60)", color: "oklch(0.88 0.015 75)" }}>
          <DialogHeader>
            <DialogTitle style={{ fontFamily: "'Fraunces', serif", color: "oklch(0.92 0.015 75)" }}>Add Vineyard Block</DialogTitle>
          </DialogHeader>
          <div className="flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Block Name *</label>
                <Input
                  value={blockForm.blockName}
                  onChange={(e) => setBlockForm((f) => ({ ...f, blockName: e.target.value }))}
                  placeholder="e.g. Block A, North Slope"
                  style={{ background: "oklch(0.11 0.006 60)", border: "1px solid oklch(0.22 0.010 60)", color: "oklch(0.88 0.015 75)", marginTop: "4px" }}
                />
              </div>
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Variety *</label>
                <Input
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Area (ha)</label>
                <Input
                  type="number"
              ...
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Planted</label>
                <Input
                  type="number"
              ...
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Training</label>
                <Select value={blockForm.trainingSystem} onValueChange={(v) => setBlockForm((f) => ({ ...f, trainingSystem: v as typeof TRAINING_SYSTEMS[number] }))}>
                  <SelectTrigger style={{ background: "oklch(0.11 0.006 60)", border: "1px solid oklch(0.22 0.010 60)", color: "oklch(0.88 0.015 75)", marginTop: "4px" }}>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent style={{ background: "oklch(0.14 0.008 60)", border: "1px solid oklch(0.22 0.010 60)" }}>
                    {TRAINING_SYSTEMS.map((t) => (
                      <SelectItem key={t} value={t} style={{ color: "oklch(0.88 0.015 75)" }}>{t}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Rootstock</label>
                <Input
              ...
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Aspect</label>
                <Input
            ...
            <div>
              <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Soil Type</label>
              <Input
            ...
            <div>
              <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Notes</label>
              <Textarea
                value={blockForm.notes}
                onChange={(e) => setBlockForm((f) => ({ ...f, notes: e.target.value }))}
                placeholder="Any additional notes about this block…"
                rows={2}
                style={{ background: "oklch(0.11 0.006 60)", border: "1px solid oklch(0.22 0.010 60)", color: "oklch(0.88 0.015 75)", marginTop: "4px", resize: "none" }}
              />
            </div>
          </div>
          <DialogFooter>
            <Button variant="ghost" onClick={() => setShowAddBlock(false)} style={{ color: "oklch(0.55 0.012 75)" }}>Cancel</Button>
            <Button
              onClick={handleAddBlock}
              disabled={addBlock.isPending}
              style={{ background: "oklch(0.72 0.12 75)", color: "oklch(0.11 0.008 60)", fontWeight: 600 }}
            >
      ...
      <Dialog open={obsBlockId !== null} onOpenChange={(open) => { if (!open) setObsBlockId(null); }}>
        <DialogContent style={{ background: "oklch(0.14 0.008 60)", border: "1px solid oklch(0.22 0.010 60)", color: "oklch(0.88 0.015 75)" }}>
          <DialogHeader>
            <DialogTitle style={{ fontFamily: "'Fraunces', serif", color: "oklch(0.92 0.015 75)" }}>
          ...
          <div className="flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Observation Type</label>
                <Select value={obsForm.observationType} onValueChange={(v) => setObsForm((f) => ({ ...f, observationType: v as typeof obsForm.observationType }))}>
                  ...
                  <SelectContent style={{ background: "oklch(0.14 0.008 60)", border: "1px solid oklch(0.22 0.010 60)" }}>
                    {OBSERVATION_TYPES.map((t) => (
                      <SelectItem key={t.value} value={t.value} style={{ color: "oklch(0.88 0.015 75)" }}>{t.label}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Date</label>
                <Input
                  type="date"
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Vintage Year</label>
                <Input
                  type="number"
              ...
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Value</label>
                <Input
                  type="number"
                  value={obsForm.value}
              ...
              <div>
                <label style={{ fontSize: "0.75rem", color: "oklch(0.55 0.012 75)", letterSpacing: "0.06em", textTransform: "uppercase" }}>Unit</label>
                <Input
                  value={obsForm.unit}
          ...
          <DialogFooter>
            <Button variant="ghost" onClick={() => setObsBlockId(null)} style={{ color: "oklch(0.55 0.012 75)" }}>Cancel</Button>
            <Button
