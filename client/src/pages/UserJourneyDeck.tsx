...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: "The commitment moment",
    cta: "Claim your tier  ·  Join the waitlist  ·  Start 14-day free trial",
    ctaMechanism: "Waitlist email capture (Founding Cohort) or Stripe checkout (14-day trial)",
    page: "/pricing → checkout / waitlist",
    bullets: [
      { label: "Waitlist path", body: "Email capture on /pricing. Low friction — no card. We follow up with an invite token. Best for cold prospects." },
      { label: "Trial path", body: "14-day free trial via Stripe. Real intent — they've picked a tier. Best for warm prospects." },
      { label: "Direct-invite path", body: "Rich sends /i/<token> personally. Bypasses signup entirely. Best for referrals and press bypass." },
    ...
    psych: "The moment of buy is a trust threshold. Every dark pattern we DON'T use costs us conversions today and buys us evangelists tomorrow. Boutique winemakers talk. So do their sommelier friends.",
  },
  {
    n: 5,
  ...
  },
  {
    ...
    ctaMechanism: "Each locked gate carries a CTA to /quick-entry + a secondary 'why this matters' learnCta",
    page: "/your-vintage",
    bullets: [
      { label: "Register → Tanks → Batch → Measurement → Fermentation → Racking → Bottling", body: "Seven gates, computed from live vintage_log data. No fake progress. No acknowledge-to-continue tutorials." },
      { label: "Skim mode", body: "Wine-pro toggle. Every gate description visible without earning. Respects experts; teaches novices." },
      { label: "The Press", body: "Full debrief hidden until Gate 6 (racking). Preview access available for wine writers via bypass request." },
      { label: "Ask Owen", body: "Grounded winemaking Q&A available from Gate 1. The user has help before they have data." },
    ],
    psych: "Progressive disclosure that respects both novices AND experts is the moat. Every locked card that softens rather than shames earns retention.",
  },
  {
    n: 7,
