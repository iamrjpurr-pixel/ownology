...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/todo",                 label: "Internal roadmap",    desc: "What's on the workbench, next up, and recently shipped. Honest and blunt — includes known gaps, security items, and internal notes. NOT for public consumption. Also at /roadmap.", audience: "admin" },
