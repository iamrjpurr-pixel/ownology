...
const SECTIONS: Section[] = [
  {
    ...
    routes: [
      ...
      { path: "/preview",              label: "Preview",             desc: "Marketing preview landing. Gated (Feb 2026 audit)", audience: "gated" },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/cascade-demo",       label: "Cascade demo",        desc: "Test rig for the harvest-crush theme cascade animation. Gated (Feb 2026 audit)", audience: "gated" },
      { path: "/copilot-mockup",     label: "Copilot mockup",      desc: "UX prototype — not wired to real data. GATED.", audience: "admin" },
      { path: "/branding-mockup",    label: "Branding mockup",     desc: "Visual identity exploration. Gated (Feb 2026 audit)", audience: "gated" },
      { path: "/onboarding-mockup",  label: "Onboarding mockup",   desc: "UX prototype of the first-time-user flow. Gated (Feb 2026 audit)", audience: "gated" },
