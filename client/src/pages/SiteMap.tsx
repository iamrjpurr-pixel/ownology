...
const SECTIONS: Section[] = [
  {
    ...
    routes: [
      ...
      { path: "/the-press",            label: "The Press (product)", desc: "Product page — cellar operations", audience: "public" },
      { path: "/free-run",             label: "Free Run (product)",  desc: "Product page — AI assistant", audience: "public" },
