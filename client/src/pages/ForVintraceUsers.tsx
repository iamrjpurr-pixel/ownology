/**
 * OWNOLOGY — For Vintrace Users Landing Page
 * Targets winemakers already using Vintrace, positioning Ownology as the
    ...
    <section className="pt-36 pb-24" style={{ background: BG_BASE }}>
      <div className="container max-w-4xl">
        ...
        <p style={{ fontFamily: SANS, fontWeight: 300, fontSize: "1.125rem", color: TEXT_MID, lineHeight: 1.75, maxWidth: "600px", marginBottom: "2.5rem" }}>
          Vintrace is the gold standard for cellar management in AU and NZ. Ownology adds the one capability it doesn't have: an AI assistant that reads your own SOPs, protocols, and vintage notes — and answers your team's questions in plain language, on the cellar floor, in seconds.
        </p>
...
function GapSection() {
  ...
  const gaps = [
    {
      q: "What's the correct SO₂ addition for our Riesling at this pH and temperature?",
      note: "Vintrace logs your SO₂ additions. It doesn't know your target or the calculation behind it.",
    },
    {
      q: "Our Pinot Noir ferment has stalled — what does our protocol say to do first?",
      note: "Vintrace records the stuck reading. Ownology reads your remediation SOP and gives the next step.",
    },
    {
      q: "What oak regime did we use on the 2021 Chardonnay and what were the sensory outcomes?",
      note: "Vintrace may have the barrel record. Ownology finds the answer in your vintage report PDF.",
    },
    {
      q: "How much Opti-MUM should we add for our Cabernet at this stage of fermentation?",
      note: "Vintrace tracks your additions. Ownology answers the 'how much and why' question from your protocols.",
    },
  ];
  return (
    <section className="py-24" style={{ background: BG_RAISED }}>
      <div className="container max-w-4xl" ref={ref}>
        ...
        <h2 style={{ fontFamily: SERIF, fontWeight: 600, fontSize: "clamp(1.75rem, 3.5vw, 2.5rem)", color: TEXT_HI, lineHeight: 1.2, letterSpacing: "-0.01em", marginBottom: "1rem", maxWidth: "560px" }}>
          Vintrace tells you what happened. Ownology tells you what to do about it.
        </h2>
        <p style={{ fontFamily: SANS, fontWeight: 300, fontSize: "1rem", color: TEXT_MID, lineHeight: 1.75, maxWidth: "540px", marginBottom: "3rem" }}>
          These are the questions your team asks every day during harvest — questions that Vintrace wasn't designed to answer.
        </p>
      ...
      <div className="container max-w-4xl" ref={ref}>
        ...
        <div className={`grid md:grid-cols-2 gap-6 ${inView ? "fade-up" : "opacity-0"}`}>
          ...
          <div className="p-8 rounded-sm" style={{ background: BG_CARD, border: `1px solid ${BORDER}` }}>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span style={{ fontFamily: SERIF, fontWeight: 600, fontSize: "1.125rem", color: TEXT_HI }}>Vintrace</span>
              <span style={{ fontFamily: SANS, fontSize: "0.75rem", color: TEXT_LO, marginLeft: "auto" }}>Production ERP</span>
            </div>
            <ul className="flex flex-col gap-3">
              {[
                "Cellar operations & task management",
                "Lab analysis & lot tracking",
                "Barrel, tank & inventory management",
                "Regulatory compliance & reporting",
                "Blend calculations & COGS",
        ...
        >
          <p style={{ fontFamily: SERIF, fontWeight: 500, fontSize: "1.0625rem", color: TEXT_HI, lineHeight: 1.6 }}>
            Vintrace is your <em style={{ color: AMBER }}>system of record</em>. Ownology is your <em style={{ color: AMBER }}>system of knowledge</em>. Most Ownology customers use both — they complement each other perfectly.
          </p>
        </div>
      </div>
    </section>
...
function Workflow() {
  ...
  const steps = [
    ...
    { n: "03", title: "Log readings in Vintrace as normal", body: "Nothing changes in your Vintrace workflow. Brix, pH, SO₂, tank notes — all still go into Vintrace. Ownology doesn't replace that; it answers the questions that come before and after the data entry." },
    ...
    <section className="py-24" style={{ background: BG_RAISED }}>
      <div className="container max-w-4xl" ref={ref}>
        ...
        <h2 style={{ fontFamily: SERIF, fontWeight: 600, fontSize: "clamp(1.75rem, 3.5vw, 2.5rem)", color: TEXT_HI, lineHeight: 1.2, letterSpacing: "-0.01em", marginBottom: "3rem", maxWidth: "520px" }}>
          How Vintrace and Ownology work together in practice.
        </h2>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://api.buttondown.email/v1/subscribers", {
        ...
        body: JSON.stringify({ email_address: email, tags: ["waitlist", "vintrace-users"] }),
      });
    ...
    <section className="py-24" style={{ background: BG_RAISED }}>
      <div className="container max-w-3xl text-center" ref={ref}>
        <div className={inView ? "fade-up" : "opacity-0"}>
          <p style={{ fontFamily: SANS, fontWeight: 700, fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase", color: AMBER, marginBottom: "1.25rem" }}>
            Add the Knowledge Layer to Your Vintrace Setup
          </p>
...
export default function ForVintraceUsers() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "For Vintrace Users — Add AI Knowledge to Your Cellar Stack | Ownology";
  }, []);
  return (
